...
class DependencyInjector:
  ...
  def get_websocket_service(db=Depends(get_database), query_service=Depends(get_query_service), connection_manager=Depends(get_websocket_connection_manager), session_service=Depends(get_session_service), yoga_agent=Depends(get_yoga_agent)):
