...
class WebSocketService:
    ...
    async def close_connection(self, websocket: WebSocket, session_id, user_id, session_task):
        end_session_response = {
            "status": True,
            "type": "session_ended",
            "result": {"text": "This is session ending. Namaste", "msg_id": "12312321"},
        }  # await self.query_service.end_user_session(session_id)
            ...
            while True:
                ...
                if message["type"] == "start_session":
                    ...
                    try:
                        ...
                        response = await self.query_service.process_user_query(
                            user_query=user_query,
                            session_id=session_id,
                            postures=postures,
                            current_posture_name=current_posture_name,
