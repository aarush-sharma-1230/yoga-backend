...
INVERSION_POSTURES = [
    ...
    },
    {
        "anatomical_signature": {
            ...
            "weight_bearing_points": ["forearms", "feet"],
        ...
        "intensity_profile": {
            "overall_exertion": 3,
            "balance_requirement": 1,
            "muscular_load": {"core": 3, "upper_body": 4, "lower_body": 1},
            "mobility_load": {"posterior_chain": 4, "hips_and_pelvis": 2, "spine": 1, "shoulders_and_chest": 3},
        },
        "chronic_pain": [
            {"action": "adjust", "condition": "shoulder_pain", "reason": "Deep shoulder flexion loads the rotator cuff.", "recommended_modification": "dolphin_at_wall"},
            {"action": "modify", "condition": "neck_pain", "reason": "Looking forward can compress the cervical spine.", "recommended_modification": "gaze_feet"},
        ],
        "client_id": "p_dolphin_pose",
        "category": "inversion",
        "common_mistakes": [
            "Collapsing the chest toward the floor",
            "Elbows splaying wider than the shoulders",
        ...
        "drishti": {"alternatives": ["between_feet"], "primary": "feet"},
        "modifications": [
            {
                "instruction": "Place your forearms on a wall at hip height and walk your feet back " "until your body forms an L-shape.",
                "name": "Dolphin at Wall",
                "target_area": "shoulders",
            },
            {
                "instruction": "Soften your knees and keep your gaze toward your feet to lengthen " "the spine.",
                "name": "Bent Knees",
        ...
        "aliases": ["Forearm Down Dog"],
        "pose_intent": [
            "Open the shoulders and prepare for inversions",
            "Strengthen the arms and upper back",
            "Stretch the hamstrings and spine",
        ],
        "progression": {
            "advanced": "Walk the feet in until hips stack over shoulders as a base for " "forearm balance.",
            "beginner": "Keep knees bent and focus on lifting the shoulders away from the ears.",
            "intermediate": "Straighten the legs while maintaining length in the spine.",
        },
        "sensory_cues": [
            {"area": "shoulders", "cue": "Draw your shoulder blades firmly onto your back."},
            {"area": "forearms", "cue": "Press the inner wrists down so the forearms stay parallel."},
        ],
        "typical_entries": ["p_downward_dog", "p_plank"],
        "typical_exits": ["p_downward_dog", "p_childs_pose", "p_table_top", "p_plank"],
    },
    {
