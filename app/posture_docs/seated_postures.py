...
SEATED_POSTURES = [
    ...
    },
    {
        ...
        "name": {"aliases": ["Seated Head to Knee"], "english": "Head-to-Knee Forward Bend", "sanskrit": "Janu Sirsasana"},
    ...
    },
    {
        ...
        "name": {"aliases": ["Half Pigeon", "Sleeping Pigeon"], "english": "Pigeon Pose", "sanskrit": "Eka Pada Rajakapotasana"},
        "pose_intent": [
