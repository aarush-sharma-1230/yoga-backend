...
class OpenAIClient:
  ...
  def generate_text(self, prompt: str, developer_prompt: str = DEVELOPER_PROMPT, model: str = "gpt-4o-mini", temperature: float = 0.7) -> str:
  ...
  def generate_audio(self, text: str, instructions: str = DEVELOPER_PROMPT, model: str = "gpt-4o-mini-tts", voice: str = "nova"):
    if self.is_api_enabled:
